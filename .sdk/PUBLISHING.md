...
|---|---|---|
| `ts/` | @voxgig-sdk/anipub-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/anipub-sdk \
      --repository voxgig-sdk/anipub-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/anipub-sdk` shows it, and
`npm trust revoke @voxgig-sdk/anipub-sdk --id=<id>` removes it.
