...
class AnipubCacheFeature extends AnipubBaseFeature
{
    ...
    private function _through(AnipubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
