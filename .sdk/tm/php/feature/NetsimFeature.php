...
class AnipubNetsimFeature extends AnipubBaseFeature
{
    ...
    private function _simulate(AnipubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AnipubContext $ctx, array $applied): void
    {
        $client = $this->client;
