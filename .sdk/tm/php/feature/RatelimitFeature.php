...
class AnipubRatelimitFeature extends AnipubBaseFeature
{
    ...
    private function _acquire(AnipubContext $ctx): void
    {
    ...
    private function _track(AnipubContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
