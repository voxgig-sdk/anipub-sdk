...
class AnipubRbacFeature extends AnipubBaseFeature
{
    ...
    private function _required(AnipubContext $ctx): ?string
    {
    ...
    private function _reject(AnipubContext $ctx, string $required): void
    {
    ...
    private function _track(AnipubContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
