...
class AnipubStreamingFeature extends AnipubBaseFeature
{
    ...
    private function _iterate(AnipubResult $result): \Generator
    {
    ...
    private function _streamable(AnipubContext $ctx): bool
    {
