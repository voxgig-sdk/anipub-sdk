...
class AnipubTimeoutFeature extends AnipubBaseFeature
{
    ...
    private function _with_timeout(AnipubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AnipubContext $_ctx, float $ms): void
    {
        $client = $this->client;
