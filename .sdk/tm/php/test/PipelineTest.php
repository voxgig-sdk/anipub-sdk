...
{
    private static function utility(): AnipubUtility
    {
        return new AnipubUtility();
    }
    ...
    private static function ctx(array $over = []): AnipubContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AnipubContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AnipubOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AnipubError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AnipubOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AnipubMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AnipubOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AnipubMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AnipubOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AnipubMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AnipubSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AnipubMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AnipubResponse([]),
            'result' => new AnipubResult([]),
        ]);
        [, $err] = AnipubMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AnipubSpec(['step' => 's']),
            'response' => new AnipubResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AnipubResult([]),
        ]);
        [, $err] = AnipubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AnipubSpec(['step' => 's']),
            'response' => new AnipubResponse(self::resp(200, ['v' => 1])),
            'result' => new AnipubResult([]),
        ]);
        [, $err] = AnipubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AnipubSpec(['step' => 's']),
            'response' => new AnipubResponse(self::resp(200, ['v' => 2])),
            'result' => new AnipubResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AnipubMakeResponse::call($ctx);
    ...
    {
        $preset = new AnipubResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AnipubSpec([]),
            'response' => new AnipubResponse([]),
            'result' => new AnipubResult([]),
        ...
        [$got, $err] = AnipubMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AnipubResult([])]);
        [, $err] = AnipubMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AnipubSpec([]), 'result' => null]);
        [, $err] = AnipubMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AnipubSpec(['step' => 's']),
            'result' => new AnipubResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AnipubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AnipubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AnipubSpec(['step' => 's']),
            'result' => new AnipubResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AnipubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AnipubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AnipubResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AnipubSpec([]),
            'result' => new AnipubResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AnipubMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AnipubMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AnipubError('boom', 'boom');
        $utility->fetcher = function (AnipubContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AnipubSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AnipubMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AnipubContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AnipubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AnipubResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AnipubContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AnipubSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AnipubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AnipubResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AnipubSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AnipubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AnipubMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AnipubMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AnipubResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AnipubDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AnipubResult(['ok' => false])]);
        $this->expectException(AnipubError::class);
        AnipubDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AnipubResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AnipubMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AnipubBaseFeature();
        $b = new AnipubBaseFeature();
        AnipubFeatureAdd::call($ctx, $a);
        AnipubFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AnipubBaseFeature
    {
        $f = new AnipubBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AnipubFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AnipubContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AnipubSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AnipubPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AnipubResponse(['headers' => null]),
            'result' => new AnipubResult([]),
        ]);
        AnipubResultHeaders::call($ctx);
