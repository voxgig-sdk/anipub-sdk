...
class AnipubFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AnipubSDK/1.0)';
    ...
    public static function call(AnipubContext $ctx, string $fullurl, array $fetchdef): array
    {
