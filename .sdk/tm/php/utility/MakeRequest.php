...
// Anipub SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AnipubMakeRequest
{
    public static function call(AnipubContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AnipubResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AnipubResponse($fetched);
        } else {
