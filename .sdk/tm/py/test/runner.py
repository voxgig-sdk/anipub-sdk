...
class AnipubTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AnipubTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AnipubTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AnipubTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
