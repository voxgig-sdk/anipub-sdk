...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AnipubOmni.make_runner(TEST_JSON_FILE, AnipubSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AnipubOmni.errify(err)
    end
