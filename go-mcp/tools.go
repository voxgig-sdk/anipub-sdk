...
type Args struct {
	Entity string         `json:"entity" jsonschema:"anime | find | full_anime_detail | info | paginated_anime_list | rating | search | streaming_detail"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AnipubSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "anipub_list",
		Description: "List records from Anipub. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "anipub_load",
		Description: "Load a single record from Anipub. " +
...
func runOp(client *sdk.AnipubSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AnipubSDK, name string) (sdk.AnipubEntity, error) {
