...
func NewAnimeEntity(client *core.AnipubSDK, entopts map[string]any) *AnimeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnimeEntity) GetName() string { return e.name }
...
func (e *AnimeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnimeEntity) Deleted() bool {
	return e.deleted
}


func (e *AnimeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnimeEntity(e.client, opts)
}

func (e *AnimeEntity) Data(args ...any) any {
...
func (e *AnimeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Anime; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnimeEntity) DataTyped(data ...Anime) Anime {
	if len(data) > 0 {
		return typedFrom[Anime](e.Data(asMap(data[0])))
	}
	return typedFrom[Anime](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Anime (all fields
// optional at the wire level).
func (e *AnimeEntity) MatchTyped(match ...Anime) Anime {
	if len(match) > 0 {
		return typedFrom[Anime](e.Match(asMap(match[0])))
	}
	return typedFrom[Anime](e.Match())
}
...
func (e *AnimeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnimeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnimeLoadMatch and returns an Anime. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AnimeEntity) LoadTyped(reqmatch AnimeLoadMatch, ctrl map[string]any) (Anime, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Anime{}, err
	}
	return typedFrom[Anime](res), nil
}



func (e *AnimeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AnimeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AnimeCreateData and returns an Anime. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AnimeEntity) CreateTyped(reqdata AnimeCreateData, ctrl map[string]any) (Anime, error) {
...
func (e *AnimeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnimeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnimeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
