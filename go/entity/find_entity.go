...
func NewFindEntity(client *core.AnipubSDK, entopts map[string]any) *FindEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FindEntity) GetName() string { return e.name }
...
func (e *FindEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FindEntity) Deleted() bool {
	return e.deleted
}


func (e *FindEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFindEntity(e.client, opts)
}

func (e *FindEntity) Data(args ...any) any {
...
func (e *FindEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Find; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FindEntity) DataTyped(data ...Find) Find {
	if len(data) > 0 {
		return typedFrom[Find](e.Data(asMap(data[0])))
	}
	return typedFrom[Find](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Find (all fields
// optional at the wire level).
func (e *FindEntity) MatchTyped(match ...Find) Find {
	if len(match) > 0 {
		return typedFrom[Find](e.Match(asMap(match[0])))
	}
	return typedFrom[Find](e.Match())
}
...
func (e *FindEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FindEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FindLoadMatch and returns an Find. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FindEntity) LoadTyped(reqmatch FindLoadMatch, ctrl map[string]any) (Find, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Find{}, err
	}
	return typedFrom[Find](res), nil
}



func (e *FindEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FindEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FindEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FindEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FindEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
