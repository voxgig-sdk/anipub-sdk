...
type FullAnimeDetailEntity struct {
	name    string
...
func NewFullAnimeDetailEntity(client *core.AnipubSDK, entopts map[string]any) *FullAnimeDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FullAnimeDetailEntity) GetName() string { return e.name }
...
func (e *FullAnimeDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FullAnimeDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *FullAnimeDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFullAnimeDetailEntity(e.client, opts)
}

func (e *FullAnimeDetailEntity) Data(args ...any) any {
...
func (e *FullAnimeDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FullAnimeDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FullAnimeDetailEntity) DataTyped(data ...FullAnimeDetail) FullAnimeDetail {
	if len(data) > 0 {
		return typedFrom[FullAnimeDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[FullAnimeDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FullAnimeDetail (all fields
// optional at the wire level).
func (e *FullAnimeDetailEntity) MatchTyped(match ...FullAnimeDetail) FullAnimeDetail {
	if len(match) > 0 {
		return typedFrom[FullAnimeDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[FullAnimeDetail](e.Match())
}
...
func (e *FullAnimeDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FullAnimeDetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FullAnimeDetailLoadMatch and returns an FullAnimeDetail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FullAnimeDetailEntity) LoadTyped(reqmatch FullAnimeDetailLoadMatch, ctrl map[string]any) (FullAnimeDetail, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FullAnimeDetail{}, err
	}
	return typedFrom[FullAnimeDetail](res), nil
}



func (e *FullAnimeDetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FullAnimeDetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FullAnimeDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FullAnimeDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FullAnimeDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
