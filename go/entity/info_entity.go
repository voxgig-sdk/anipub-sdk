...
func NewInfoEntity(client *core.AnipubSDK, entopts map[string]any) *InfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InfoEntity) GetName() string { return e.name }
...
func (e *InfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InfoEntity) Deleted() bool {
	return e.deleted
}


func (e *InfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInfoEntity(e.client, opts)
}

func (e *InfoEntity) Data(args ...any) any {
...
func (e *InfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Info; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InfoEntity) DataTyped(data ...Info) Info {
	if len(data) > 0 {
		return typedFrom[Info](e.Data(asMap(data[0])))
	}
	return typedFrom[Info](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Info (all fields
// optional at the wire level).
func (e *InfoEntity) MatchTyped(match ...Info) Info {
	if len(match) > 0 {
		return typedFrom[Info](e.Match(asMap(match[0])))
	}
	return typedFrom[Info](e.Match())
}
...
func (e *InfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InfoLoadMatch and returns an Info. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InfoEntity) LoadTyped(reqmatch InfoLoadMatch, ctrl map[string]any) (Info, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Info{}, err
	}
	return typedFrom[Info](res), nil
}



func (e *InfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
