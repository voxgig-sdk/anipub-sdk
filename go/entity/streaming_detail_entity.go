...
type StreamingDetailEntity struct {
	name    string
...
func NewStreamingDetailEntity(client *core.AnipubSDK, entopts map[string]any) *StreamingDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StreamingDetailEntity) GetName() string { return e.name }
...
func (e *StreamingDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StreamingDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *StreamingDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStreamingDetailEntity(e.client, opts)
}

func (e *StreamingDetailEntity) Data(args ...any) any {
...
func (e *StreamingDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StreamingDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StreamingDetailEntity) DataTyped(data ...StreamingDetail) StreamingDetail {
	if len(data) > 0 {
		return typedFrom[StreamingDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[StreamingDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StreamingDetail (all fields
// optional at the wire level).
func (e *StreamingDetailEntity) MatchTyped(match ...StreamingDetail) StreamingDetail {
	if len(match) > 0 {
		return typedFrom[StreamingDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[StreamingDetail](e.Match())
}
...
func (e *StreamingDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StreamingDetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StreamingDetailLoadMatch and returns an StreamingDetail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StreamingDetailEntity) LoadTyped(reqmatch StreamingDetailLoadMatch, ctrl map[string]any) (StreamingDetail, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return StreamingDetail{}, err
	}
	return typedFrom[StreamingDetail](res), nil
}



func (e *StreamingDetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StreamingDetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StreamingDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StreamingDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StreamingDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
