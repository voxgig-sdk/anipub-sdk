...
func TestRatingEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ANIPUB_TEST_RATING_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func ratingBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ANIPUB_TEST_RATING_ENTID")
	...
	idmapResolved := core.ToMapAny(env["ANIPUB_TEST_RATING_ENTID"])
