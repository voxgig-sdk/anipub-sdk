...
const testSeed = `map[string]any{"entity": map[string]any{"anime": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "find": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "full_anime_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paginated_anime_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rating": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "streaming_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
