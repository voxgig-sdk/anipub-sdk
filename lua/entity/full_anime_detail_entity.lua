...
local FullAnimeDetailEntity = {}
FullAnimeDetailEntity.__index = FullAnimeDetailEntity


function FullAnimeDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FullAnimeDetailEntity)
  self._name = "full_anime_detail"
  self._client = client
...
function FullAnimeDetailEntity:get_name()
  return self._name
end


function FullAnimeDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FullAnimeDetailEntity.new(self._client, opts)
end
...
function FullAnimeDetailEntity:mark_deleted()
  self._deleted = true
end


function FullAnimeDetailEntity:deleted()
  return true == self._deleted
end


function FullAnimeDetailEntity:data_set(args)
  if args ~= nil then
...
function FullAnimeDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FullAnimeDetailEntity:match_set(args)
  if args ~= nil then
...
function FullAnimeDetailEntity:match_get()
...
function FullAnimeDetailEntity:stream(action, args, callopts)
...
---@param reqmatch FullAnimeDetailLoadMatch
---@param ctrl? table
---@return FullAnimeDetail
---@return string? err
function FullAnimeDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FullAnimeDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
