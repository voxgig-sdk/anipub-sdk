...
local PaginatedAnimeListEntity = {}
PaginatedAnimeListEntity.__index = PaginatedAnimeListEntity


function PaginatedAnimeListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedAnimeListEntity)
  self._name = "paginated_anime_list"
  self._client = client
...
function PaginatedAnimeListEntity:get_name()
  return self._name
end


function PaginatedAnimeListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedAnimeListEntity.new(self._client, opts)
end
...
function PaginatedAnimeListEntity:mark_deleted()
  self._deleted = true
end


function PaginatedAnimeListEntity:deleted()
  return true == self._deleted
end


function PaginatedAnimeListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedAnimeListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedAnimeListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedAnimeListEntity:match_get()
...
function PaginatedAnimeListEntity:stream(action, args, callopts)
...
---@param reqmatch PaginatedAnimeListLoadMatch
---@param ctrl? table
---@return PaginatedAnimeList
---@return string? err
function PaginatedAnimeListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PaginatedAnimeListListMatch
---@param ctrl? table
---@return PaginatedAnimeList[]
---@return string? err
function PaginatedAnimeListEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function PaginatedAnimeListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedAnimeListEntity
