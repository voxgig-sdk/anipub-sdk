...
describe("AnimeDirect", function()
  it("should direct-load-anime", function()
    local setup = anime_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-anime", setup.live and "live" or "unit")
