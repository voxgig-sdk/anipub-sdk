...
describe("AnimeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ANIPUB_TEST_ANIME_ENTID JSON to run live")
      return
    end
    ...
    local anime_ref01_data = helpers.to_map(vs.getprop(
...
function anime_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ANIPUB_TEST_ANIME_ENTID")
