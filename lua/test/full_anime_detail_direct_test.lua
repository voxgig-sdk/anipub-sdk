...
describe("FullAnimeDetailDirect", function()
  it("should direct-load-full_anime_detail", function()
    local setup = full_anime_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-full_anime_detail", setup.live and "live" or "unit")
