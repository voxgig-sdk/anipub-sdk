...
describe("InfoDirect", function()
  it("should direct-load-info", function()
    local setup = info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-info", setup.live and "live" or "unit")
