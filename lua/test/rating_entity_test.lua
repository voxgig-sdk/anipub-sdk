...
describe("RatingEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ANIPUB_TEST_RATING_ENTID JSON to run live")
      return
    end
...
function rating_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ANIPUB_TEST_RATING_ENTID")
