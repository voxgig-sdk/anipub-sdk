...
-- data to return.
local TEST_SEED = '{ entity = { ["anime"] = { ["test01"] = { id = "test01" } }, ["find"] = { ["test01"] = { id = "test01" } }, ["full_anime_detail"] = { ["test01"] = { id = "test01" } }, ["info"] = { ["test01"] = { id = "test01" } }, ["paginated_anime_list"] = { ["test01"] = { id = "test01" } }, ["rating"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["streaming_detail"] = { ["test01"] = { id = "test01" } } } }'
