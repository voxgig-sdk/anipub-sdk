...
class AnimeEntity
{
     ...
     * Load a single Anime.
     *
     * @param AnimeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AnimeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Anime|array The loaded Anime as an assoc-array at the
     ...
     * Create a new Anime.
     *
     * @param AnimeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AnimeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Anime|array The created Anime as an assoc-array at the
     *   SDK boundary; throws AnipubError on failure (item-5 convention).
     */
