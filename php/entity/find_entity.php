...
class FindEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FindEntity($this->_client, $opts);
    }

    /**
     * @param Find|array $args Find data (assoc-array) to store.
     */
    ...
    /**
     * @return Find|array The current Find data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Find fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Find fields).
     */
     ...
     * Load a single Find.
     *
     * @param FindLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FindLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Find|array The loaded Find as an assoc-array at the
