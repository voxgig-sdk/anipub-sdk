...
// Anipub SDK FullAnimeDetail entity
...
class FullAnimeDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FullAnimeDetailEntity($this->_client, $opts);
    }

    /**
     * @param FullAnimeDetail|array $args FullAnimeDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return FullAnimeDetail|array The current FullAnimeDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FullAnimeDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FullAnimeDetail fields).
     */
    ...
    /**
     * Load a single FullAnimeDetail.
     *
     * @param FullAnimeDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FullAnimeDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FullAnimeDetail|array The loaded FullAnimeDetail as an assoc-array at the
