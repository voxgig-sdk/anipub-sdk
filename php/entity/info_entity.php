...
class InfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InfoEntity($this->_client, $opts);
    }

    /**
     * @param Info|array $args Info data (assoc-array) to store.
     */
    ...
    /**
     * @return Info|array The current Info data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Info fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Info fields).
     */
     ...
     * Load a single Info.
     *
     * @param InfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Info|array The loaded Info as an assoc-array at the
