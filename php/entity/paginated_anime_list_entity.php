...
// Anipub SDK PaginatedAnimeList entity
...
class PaginatedAnimeListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_anime_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedAnimeListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedAnimeList|array $args PaginatedAnimeList data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = AnipubHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return PaginatedAnimeList|array The current PaginatedAnimeList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedAnimeList fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = AnipubHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of PaginatedAnimeList fields).
     */
    ...
    /**
     * Load a single PaginatedAnimeList.
     *
     * @param PaginatedAnimeListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PaginatedAnimeListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaginatedAnimeList|array The loaded PaginatedAnimeList as an assoc-array at the
     *   SDK boundary; throws AnipubError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = AnipubHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List PaginatedAnimeList items matching the given filter.
     *
     * @param PaginatedAnimeListListMatch|array|null $reqmatch Match filter (any subset
     *   of PaginatedAnimeList fields) as an assoc-array; PaginatedAnimeListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaginatedAnimeList[]|array A list of PaginatedAnimeList items as assoc-arrays at
     *   the SDK boundary; throws AnipubError on failure (item-5 convention).
     */
