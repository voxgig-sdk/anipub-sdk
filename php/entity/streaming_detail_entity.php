...
// Anipub SDK StreamingDetail entity
...
class StreamingDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StreamingDetailEntity($this->_client, $opts);
    }

    /**
     * @param StreamingDetail|array $args StreamingDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return StreamingDetail|array The current StreamingDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StreamingDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StreamingDetail fields).
     */
    ...
    /**
     * Load a single StreamingDetail.
     *
     * @param StreamingDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StreamingDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StreamingDetail|array The loaded StreamingDetail as an assoc-array at the
