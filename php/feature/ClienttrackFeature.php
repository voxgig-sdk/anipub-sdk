...
// Anipub SDK clienttrack feature
...
class AnipubClienttrackFeature extends AnipubBaseFeature
{
    ...
    public function PostConstruct(AnipubContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Anipub-SDK';
