...
class AnipubProxyFeature extends AnipubBaseFeature
{
    ...
    public function init(AnipubContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AnipubContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
