...
// Anipub SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AnipubTestFeature extends AnipubBaseFeature
{
    ...
    public function init(AnipubContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AnipubContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AnipubContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AnipubContext $ctx, $op, $args): array
    {
