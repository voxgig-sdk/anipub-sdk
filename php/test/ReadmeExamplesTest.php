...
// Anipub SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AnipubSDK::test)
...
{
    private const SDK_CLASS = 'AnipubSDK';
    ...
    private const SDK_BASE = 'anipub_sdk';
