...
class AnipubTestRunner
{
    ...
    {
        $live = self::getenv('ANIPUB_TEST_LIVE');
        $override = self::getenv('ANIPUB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ANIPUB_TEST_EXPLAIN');
...
class_alias('AnipubTestRunner', 'Runner');
class_alias('AnipubHelpers', 'Helpers');
