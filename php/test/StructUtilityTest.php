...
// Anipub SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AnipubOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AnipubOmni::structfix($now, Struct::undef()))
                        !== json_encode(AnipubOmni::structfix($val, Struct::undef()))) {
