...
from anipub_sdk.core.helpers import get_ctx_prop, to_map
...
class AnipubContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, AnipubResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AnipubError(code, msg, self)
