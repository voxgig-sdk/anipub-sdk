...
class FullAnimeDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FullAnimeDetailEntity(self._client, opts)
    ...
    def data_get(self) -> FullAnimeDetail:
    ...
    def match_get(self) -> FullAnimeDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FullAnimeDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FullAnimeDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
