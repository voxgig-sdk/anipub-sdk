...
from anipub_sdk.anipub_types import (
    PaginatedAnimeList,
...
class PaginatedAnimeListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaginatedAnimeListEntity(self._client, opts)
    ...
    def data_get(self) -> PaginatedAnimeList:
    ...
    def match_get(self) -> PaginatedAnimeList:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PaginatedAnimeList:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PaginatedAnimeList().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaginatedAnimeList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaginatedAnimeList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
