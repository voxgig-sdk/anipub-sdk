...
class StreamingDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StreamingDetailEntity(self._client, opts)
    ...
    def data_get(self) -> StreamingDetail:
    ...
    def match_get(self) -> StreamingDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> StreamingDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.StreamingDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
