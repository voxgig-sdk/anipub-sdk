# Anipub SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AnipubSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AnipubSDK(...) and AnipubSDK.test(...) become
#      AnipubSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "anipub_sdk"
_SDK_CLASS = "AnipubSDK"
