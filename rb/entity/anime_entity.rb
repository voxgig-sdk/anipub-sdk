...
class AnimeEntity
  ...
  # @return [Anime, Hash] the loaded Anime; raises AnipubError on failure
  ...
  # Create a new Anime.
  #
  # @param reqdata [AnimeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Anime, Hash] the created Anime; raises AnipubError on failure
