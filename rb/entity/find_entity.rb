...
class FindEntity
  ...
  # @return [Find, Hash] the current Find data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Find fields)
  def match_get
  ...
  # Load a single Find.
  #
  # @param reqmatch [FindLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Find.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Find, Hash] the loaded Find; raises AnipubError on failure
