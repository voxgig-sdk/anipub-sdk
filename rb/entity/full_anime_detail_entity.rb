...
class FullAnimeDetailEntity
  ...
  def make
    opts = @_entopts.dup
    FullAnimeDetailEntity.new(@_client, opts)
  end
  ...
  # @return [FullAnimeDetail, Hash] the current FullAnimeDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FullAnimeDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [FullAnimeDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FullAnimeDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FullAnimeDetail, Hash] the loaded FullAnimeDetail; raises AnipubError on failure
