...
class InfoEntity
  ...
  # Load a single Info.
  #
  # @param reqmatch [InfoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Info.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Info, Hash] the loaded Info; raises AnipubError on failure
