...
class StreamingDetailEntity
  ...
  def make
    opts = @_entopts.dup
    StreamingDetailEntity.new(@_client, opts)
  end
  ...
  # @return [StreamingDetail, Hash] the current StreamingDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StreamingDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [StreamingDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StreamingDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StreamingDetail, Hash] the loaded StreamingDetail; raises AnipubError on failure
