...
module AnipubTestRunner
  ...
  def self.env_override(m)
    live = getenv("ANIPUB_TEST_LIVE")
    override = getenv("ANIPUB_TEST_OVERRIDE")
    ...
    explain = getenv("ANIPUB_TEST_EXPLAIN")
    m["ANIPUB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AnipubTestRunner
Helpers = AnipubHelpers
Vs = VoxgigStruct
