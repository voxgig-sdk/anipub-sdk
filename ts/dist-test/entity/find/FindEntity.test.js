...
(0, node_test_1.describe)('FindEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/find/FindTestData.json');
    ...
    let idmap = transform(['find01', 'find02', 'find03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FindEntity.test.js.map