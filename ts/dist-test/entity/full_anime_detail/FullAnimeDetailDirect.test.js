...
(0, node_test_1.describe)('FullAnimeDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-full_anime_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-full_anime_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANIPUB_TEST_FULL_ANIME_DETAIL_ENTID'];
...
//# sourceMappingURL=FullAnimeDetailDirect.test.js.map