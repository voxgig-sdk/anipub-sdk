...
(0, node_test_1.describe)('InfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-info', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANIPUB_TEST_INFO_ENTID'];
...
//# sourceMappingURL=InfoDirect.test.js.map