...
(0, node_test_1.describe)('StreamingDetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-streaming_detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-streaming_detail', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANIPUB_TEST_STREAMING_DETAIL_ENTID'];
...
//# sourceMappingURL=StreamingDetailDirect.test.js.map