...
Object.defineProperty(exports, "AnipubEntityBase", { enumerable: true, get: function () { return AnipubEntityBase_1.AnipubEntityBase; } });
...
class AnipubSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('AnipubSDK: graphql: ' +
    ...
    Anime(entopts) {
        const self = this;
        return new AnimeEntity_1.AnimeEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    FullAnimeDetail(entopts) {
        const self = this;
        return new FullAnimeDetailEntity_1.FullAnimeDetailEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    StreamingDetail(entopts) {
        const self = this;
        return new StreamingDetailEntity_1.StreamingDetailEntity(self, entopts);
    }
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new AnipubSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return AnipubSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'Anipub' };
    }
    toString() {
        return 'Anipub ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.AnipubSDK = AnipubSDK;
const SDK = AnipubSDK;
exports.SDK = SDK;
//# sourceMappingURL=AnipubSDK.js.map